            ...
            if (opacity > 0.0) {
              ...
              final EdgeInsetsGeometry padding = widget.titlePadding ??
                  EdgeInsetsDirectional.only(
                    start: effectiveCenterTitle ? 50.0 : 20.0,
                    end: effectiveCenterTitle ? 50.0 : 20.0,
                    // top: 20,
                    bottom: 10.0,
                  );
              final double scaleValue = Tween<double>(begin: 1.0, end: 1.0).transform(t);
              final Matrix4 scaleTransform = Matrix4.identity()
                ..scale(scaleValue, scaleValue, 1.0);
              print("t === ${t}");
              print("title===scaleValue===${scaleValue}");
                  ...
                  child: Align(
                    ...
                    child: DefaultTextStyle(
                      ...
                      child: LayoutBuilder(
                          builder: (BuildContext context, BoxConstraints constraints) {
                            return Container(
                              width: constraints.maxWidth * ((1-t)> 0.6 ? 1-t : 0.6),
                              // width: 150,
                              alignment: titleAlignment,
                              child: title,
                            );
